...
public class AssignmentDetailsReadModelTypeResolver : DefaultJsonTypeInfoResolver
{
    public override JsonTypeInfo GetTypeInfo(Type type, JsonSerializerOptions options)
    {
        ...
        Type baseType = typeof(AssignmentDetailsReadModel);
        ...
        if (jsonTypeInfo.Type == baseType)
        {
            ...
            var jsonDerivedTypes = new List<JsonDerivedType>()
            {
                new(typeof(MultipleChoiceAssignmentDetailsReadModel), "MultipleChoiceAssignment")
            };
