...
{
    // TODO: Simplify blank assignment, maybe use simple substring lookup e. g. "[blank]"
    ...
    public FillInTheBlankQuestion(string templateText, List<FillInTheBlankAnswer> answers)
    {
